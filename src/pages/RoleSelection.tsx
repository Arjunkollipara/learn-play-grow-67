...
const floatingElements = [
  ...
  { emoji: '✏️', className: 'top-[20%] right-[15%] animate-float', delay: '0.5s' },
  { emoji: '🎨', className: 'bottom-[25%] left-[8%] animate-float', delay: '1s' },
  { emoji: '🔬', className: 'bottom-[20%] right-[10%] animate-float', delay: '1.5s' },
  { emoji: '🌟', className: 'top-[40%] left-[5%] animate-sparkle', delay: '0.3s' },
  { emoji: '🎯', className: 'top-[35%] right-[8%] animate-bounce-gentle', delay: '0.7s' },
];
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-1/3 -right-40 w-[600px] h-[600px] bg-gradient-to-bl from-student-orange/25 to-student-pink/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
        <div className="absolute -bottom-40 left-1/3 w-[500px] h-[500px] bg-gradient-to-tr from-student-green/25 to-student-yellow/15 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 min-h-screen flex flex-col">
        ...
        <header className="text-center mb-8 animate-fade-in">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-student-blue/10 via-student-purple/10 to-student-orange/10 px-6 py-2 rounded-full border border-primary/20 mb-6">
            ...
            <span className="text-sm font-medium text-foreground">Learning Made Fun & Easy</span>
            <Sparkles className="w-4 h-4 text-student-yellow" />
          </div>
        </header>
        ...
        {/* Footer */}
        <footer className="text-center py-6 animate-fade-in" style={{ animationDelay: '0.8s' }}>
          <p className="text-sm text-muted-foreground font-display">
            Made with <Heart className="inline w-4 h-4 text-student-pink animate-pulse" /> for young learners everywhere
          </p>
